    ...
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <!-- DATA TABLE -->
                    <h3 class="title-5 m-b-35">Master Universitas</h3>
                    ...
                    <table id="table_universitas" class="display text-center">
                        <thead>
                            <tr>
                                <th width="20px">No</th>
                                <th>Nama Provinsi</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="table-data-feature">
                                        <a href="<?php echo base_url(); ?>admin/master/update-universitas/<?php echo $value->id; ?>" class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                            <i class="zmdi zmdi-edit"></i>
                                        </a>
                                        <a href="<?php echo base_url(); ?>admin/master/delete-universitas/<?php echo $value->id; ?>" class="item" data-toggle="tooltip" data-placement="top" title="Delete">
                                            <i class="zmdi zmdi-delete"></i>
                                        </a>
                                    </div>
                                    <?php } else { ?>
                                    <div class="table-data-feature">
                                        <a href="<?php echo base_url(); ?>admin/master/active-universitas/<?php echo $value->id; ?>" class="item" data-toggle="tooltip" data-placement="top" title="Active">
