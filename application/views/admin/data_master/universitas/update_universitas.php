                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">Update Data Universitas</div>
                                    <div class="card-body">
                                        <form action="<?php echo base_url(); ?>Admin/Data_master/submit_update_universitas" method="post" novalidate="novalidate">
                                        ...
                                        <input type="hidden" id="id" name="id" placeholder ="id" value="<?php echo $id; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="nama" name="nama" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="Masukkan nama universitas" value="<?php echo $nama; ?>" required>
                                            </div>
                                            </div>
                                            <div>
